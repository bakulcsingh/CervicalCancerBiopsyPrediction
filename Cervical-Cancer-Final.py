...
score_cv_log_test = np.average(cross_val_score(logistic_classifier, X_test, y_test, cv=4))
...
score_cv_lsvc_test = np.average(cross_val_score(linearsvc, X_test, y_test, cv=4))
...
score_cv_sgd_test = np.average(cross_val_score(sgdclassifier, X_test, y_test, cv=4))
...
X_new_train = data_new[0:700,0:27]
X_new_test = data_new[701:858,0:27]
...
score_cv_log_test_hinselmann = np.average(cross_val_score(logistic_classifier_hinselmann, X_new_test, y_new_hinselmann_test, cv=4))
...
y_mod_feat_hinselmann_train = data_modified_features[0:700,28]
y_mod_feat_hinselmann_test = data_modified_features[701:858,28]
y_mod_feat_schiller_train = data_modified_features[0:700,29]
y_mod_feat_schiller_test = data_modified_features[701:858,29]
y_mod_feat_citology_train = data_modified_features[0:700,30]
y_mod_feat_citology_test = data_modified_features[701:858,30]
...
score_cv_log_test_hinselmann_mod_feat = np.average(cross_val_score(logistic_classifier_hinselmann_mod_feat, X_mod_feat_test, y_mod_feat_hinselmann_test, cv=4))
...
score_cv_log_test_schiller_mod_feat = np.average(cross_val_score(logistic_classifier_schiller_mod_feat, X_mod_feat_test, y_mod_feat_schiller_test, cv=4))
...
score_cv_log_test_citology_mod_feat = np.average(cross_val_score(logistic_classifier_citology_mod_feat, X_mod_feat_test, y_mod_feat_citology_test, cv=4))
